...
Type: schema
Content: Operationalized scoring rubric. base_score org_type {governing_body_league:40, content_producer:20, broadcaster:20, individual_club_team:15, regulator:-20, gambling_operator:0, hardware_vendor:0, other:0, unknown:0}; produces_content {true:20}; geography {ANZ/AU/NZ:10}; revenue_band {5-50M:10, 50-500M:10, 500-750M:-5, 750M-1B:-15, 1B-1.2B:-30, 1.2B+:-50}. graduated_deductions {} (empty — the prior gambling_operator:-20 was removed, `46-DECISION.md` D-03). hard_vetoes {non_anz, no_content, hardware_vendor}. tier_rules {A≥70, B 40-69, C 15-39, D=veto, Unscored=missing inputs}. individual_club_team and regulator amended 2026-08-11 per `46-DECISION.md` D-01/D-02 (GTM overrides of the original PRD's +5/+5); no longer matches the original PRD REQ-icp-scoring-model numerically for these two keys — see `.planning/intel/requirements.md`'s own amendment.
