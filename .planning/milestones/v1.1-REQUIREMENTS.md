...
- [ ] **GRANT-03**: A grant is **scoped to a named batch**, not to a duration alone. "Everything
...
- [ ] **GRANT-05**: Revocation mid-run is possible and takes effect within one chunk boundary.
