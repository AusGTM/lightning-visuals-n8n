...
Last activity: 2026-09-04 — Completed quick task 260904-5sd: suggest-contacts falls back to client-side web search when the sitemap ladder ends clean-but-empty, ranked by source with rank 3 always held
