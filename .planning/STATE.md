...
Last activity: 2026-09-05 — v1.2 'Yield and Friction' defined (phases 64-69, milestone switch deliberately not run while v1.1 has 3 open phases); quick task 260905-rf1 landed, so one-word club titles classify and no existing classification flipped
