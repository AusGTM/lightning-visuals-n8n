...
- (e) Created contact `352522004980` hand-deleted by the operator (restorable archive) — `DELETE` returned `204` on 2026-09-15 (a `GET` immediately before returned `200`, confirming it had still existed) — met.
