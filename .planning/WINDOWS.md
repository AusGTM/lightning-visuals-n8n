...
[
  ...
  },
  {
    ...
    "file": "scripts/build_cloud_workflows.py",
    "line": null,
    "description": "Enrichment-lane contacts branch and companies branch have no HubSpot property-history hop (only contact ingest does) -- industry/enrichment-lane jobtitle recency stay unobservable, needs_review always. Decision needed: add the hop there too, or accept lv_<field>_verified_at cache keys as a narrower substitute.",
    "status": "open",
    "reason": "",
