...
| RB-3 | **23-06** install + armed create canary | ✅ **Section B now runnable** | Defects 1+2 fixed by 23-07; defect 3 (23-01 committed-but-undeployed) **resolved 2026-08-03** — disarmed deploy + read-back PASS, create gate live in `Decide Action`. Steps 2b/2c are DONE; the armed window itself remains yours |
