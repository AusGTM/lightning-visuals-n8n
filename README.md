...
| Committed `n8n/*.json` vs the running n8n Cloud instance | ⚠️ **committed ahead of deployed since 2026-09-04.** Phase 62's JSON was deployed and bounced 2026-09-02 (`63-DEPLOY-RECORD.md`, execution `12070`); Phase 66 and quick 260904-5a8/260904-pav regenerated the workflow JSON on 2026-09-04 and committed it **without deploying** (CLAUDE.md §13.0.2). UAT runbook: `docs/OPERATOR-AUTONOMOUS-BATCH-UAT.md`. Do not read an in-repo node as proof of what n8n is running |
