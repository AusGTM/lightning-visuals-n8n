...
| Committed `n8n/*.json` vs the running n8n Cloud instance | ✅ **level as of 2026-09-09** — Phase 66 + quick 260904-5a8/260904-pav deployed disarmed and bounced (`scripts/bounce_n8n_workflows.py`; live nodes 17/29/123/26/39, write flags `false`), read back via `docs/OPERATOR-AUTONOMOUS-BATCH-UAT.md` §1c. Phase 62 had landed 2026-09-02 (`63-DEPLOY-RECORD.md`). Nothing armed Do not read an in-repo node as proof of what n8n is running |
